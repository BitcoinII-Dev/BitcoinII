...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("000000008e0241217a0c31509cc92ef8367d6add5668e07fd36269e287b5e7ef"); // Optional: only enforced at height
        ...
        // BIP9 deployment for Segwit
        
        consensus.nRuleChangeActivationThreshold = 1815; // 90% of 2016
        consensus.nMinerConfirmationWindow = 2016; // nPowTargetTimespan / nPowTargetSpacing

        // Taproot BIP9 deployment
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartTime = 1734019071;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeout = 18942120000;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].min_activation_height = 300;
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000000001aa01aa01aa");
        consensus.defaultAssumeValid = uint256S("0x00000000dc956ee0d18f0e8f401c4dc3f248d00ca1c3f8ea0d60c6842b022390"); // 425
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000379eca4e51372f2b154c8287e189c461335a8b98aff26eeb74bca0a4"));
        assert(genesis.hashMerkleRoot == uint256S("0x80d1b4e9ca868f83b88b9301036205876072bdd3ded0ad4dc022e1f9266ddc49"));
